...
const Login = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      setLoading(true);
      try {
        const response = await loginUser(values, ROLES.RETAILER);
    ...
    <>
      ...
      <div className="flex items-center justify-center mt-0">
        <section className="relative bg-white w-full mt-10 flex items-center justify-center">
          ...
          >
            <h2 className="text-4xl font-bold dark:text-white text-center mb-6">Retailer Login</h2>

            <h4 className="text-center mb-3 text-black">
              Do you have an account?{" "}
              <Link to="/retailer/register" className="font-bold text-black">
                Sign up for free
              </Link>
            </h4>
            ...
            <div className="text-center mt-4">
              <a href="/retailer/forgot-password" className="text-blue-600 hover:underline">
