...
const ChangePassword = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      setLoading(true);
      try {
        const response = await changPassword({ password: values.password, role: ROLES.RETAILER });
    ...
    <>
      ...
      <div className="flex items-center justify-center mt-0">
        <section className="relative bg-white w-full mt-10 flex items-center justify-center">
          ...
          <div
            className="relative z-10 bg-gray-200 bg-cover bg-center bg-no-repeat p-16 w-[600px] h-[300px]"
          >
